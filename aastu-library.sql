...
<head>
  ...
  <link rel="shortcut icon" href="favicon.ico" type="image/x-icon">
    ...
    <link rel="stylesheet" type="text/css" href="./themes/pmahomme/css/theme.css?v=5.1.3&nocache=2091604485ltr&server=1">
...
<body>
  ...
  <div class="pma_quick_warp"><div class="drop_list"><button title="Recent tables" class="drop_button btn">Recent</button><ul id="pma_recent_list"><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=aastu-library&table=donate_record">`aastu-library`.`donate_record`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=aastu-library&table=book_tag">`aastu-library`.`book_tag`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=aastu-library&table=comment_and_rating">`aastu-library`.`comment_and_rating`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=aastu-library&table=user">`aastu-library`.`user`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=aastu-library&table=tag">`aastu-library`.`tag`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=aastu-library&table=resource">`aastu-library`.`resource`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=aastu-library&table=admin">`aastu-library`.`admin`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=aastu-library&table=login">`aastu-library`.`login`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=nahom&table=studies">`nahom`.`studies`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=nahom&table=students">`nahom`.`students`</a></li></ul></div><div class="drop_list"><button title="Favorite tables" class="drop_button btn">Favorites</button><ul id="pma_favorite_list"><li class="warp_link">There are no favorite tables.</li></ul></div><div class="clearfloat"></div></div>
...
<div id='pma_navigation_tree_content'>
  ...
  <input type="hidden" name="tab_hash" value="">
    ...
    <input type="hidden" name="token" value="2b395322704455627d3d644f56365650">
  ...
  <div id="pma_console_container">
    <div id="pma_console">
                ...
                <div class="message welcome">
                    ...
                    <span class="hide" id="instructions-1">
                        Press Enter to execute query                    </span>
                            ...
                            targetdb="aastu-library" targettable="login">
            ...
            Queried time
                            ...
                            <span class="query">SELECT * FROM `login`</span>
                        </div>
                                            <div class="message history collapsed hide select"
                            targetdb="aastu-library" targettable="login">
                            <div class="action_content">
            ...
            Queried time
                            ...
                            <span class="query">SELECT * FROM `login`</span>
                                            ...
                                            <div class="message history collapsed hide select"
                            targetdb="aastu-library" targettable="user">
                            <div class="action_content">
                    <span class="action collapse">
            Collapse
                    </span>
            ...
            Queried time
                            ...
                            targetdb="aastu-library" targettable="admin">
                            <div class="action_content">
                    <span class="action collapse">
            Collapse
                    </span>
            ...
            Queried time
                            ...
                            <span class="query">CREATE TABLE `aastu-library`.`admin` ( `admin_id` INT(11) NOT NULL AUTO_INCREMENT ,  `first_name` VARCHAR(20) NOT NULL ,  `last_name` VARCHAR(20) NOT NULL ,  `gender` VARCHAR(1) NOT NULL ,  `username` VARCHAR(20) NOT NULL ,  `password` VARCHAR(20) NOT NULL ,  `email` VARCHAR(25) NOT NULL ,  `phone` VARCHAR(25) NOT NULL ,    PRIMARY KEY  (`admin_id`)) ENGINE = InnoDB;</span>
                        </div>
                                            <div class="message history collapsed hide"
                            targetdb="aastu-library" targettable="resource">
                            <div class="action_content">
                    <span class="action collapse">
            Collapse
                    </span>
            ...
            Queried time
                            ...
                            <span class="query">CREATE TABLE `aastu-library`.`resource` ( `resource_id` INT(11) NOT NULL AUTO_INCREMENT ,  `resource_type` VARCHAR(15) NOT NULL ,  `resource_title` VARCHAR(30) NOT NULL ,  `resource_author` VARCHAR(30) NOT NULL ,  `resource_desc` VARCHAR(300) NOT NULL ,  `resource_cover` MEDIUMBLOB NOT NULL ,  `resource_file` LONGBLOB NOT NULL ,  `user_id` INT NOT NULL ,    PRIMARY KEY  (`resource_id`)) ENGINE = InnoDB;</span>
                        </div>
                                            <div class="message history collapsed hide"
                            targetdb="aastu-library" targettable="tag">
                            <div class="action_content">
                    <span class="action collapse">
            Collapse
                    </span>
            ...
            Queried time
                            ...
                            <span class="query">CREATE TABLE `aastu-library`.`tag` ( `tag_id` INT(11) NOT NULL AUTO_INCREMENT ,  `tag_name` VARCHAR(20) NOT NULL ,    PRIMARY KEY  (`tag_id`)) ENGINE = InnoDB;</span>
                        </div>
                                            <div class="message history collapsed hide"
                            targetdb="aastu-library" targettable="comment_and_rating">
                            <div class="action_content">
                    <span class="action collapse">
            Collapse
                    </span>
            ...
            Queried time
                            ...
                            <span class="query">CREATE TABLE `aastu-library`.`comment_and_rating` ( `comment_id` INT NOT NULL AUTO_INCREMENT ,  `comment` VARCHAR(300) NOT NULL ,  `comment_date` DATETIME NOT NULL ,  `user_id` INT(11) NOT NULL ,  `resource_id` INT(11) NOT NULL ,    PRIMARY KEY  (`comment_id`)) ENGINE = InnoDB;</span>
                        </div>
                                            <div class="message history collapsed hide select"
                            targetdb="aastu-library" targettable="comment_and_rating">
                            <div class="action_content">
            ...
            Queried time
                            ...
                            <span class="query">SELECT * FROM `comment_and_rating`</span>
                        </div>
                                            <div class="message history collapsed hide select"
                            targetdb="aastu-library" targettable="comment_and_rating">
                            <div class="action_content">
            ...
            Queried time
                            ...
                            <span class="query">ALTER TABLE `comment_and_rating` DROP `resource_id`;</span>
                        </div>
                                            <div class="message history collapsed hide"
                            targetdb="aastu-library" targettable="comment_and_rating">
                            <div class="action_content">
            ...
            Queried time
                            ...
                            <span class="query">ALTER TABLE `comment_and_rating` DROP `user_id`;</span>
                        </div>
                                            <div class="message history collapsed hide select"
                            targetdb="aastu-library" targettable="user">
                            <div class="action_content">
            ...
            Queried time
                            ...
                            <span class="query">SELECT * FROM `comment_and_rating`</span>
                                            ...
                                            <div class="message history collapsed hide"
                            targetdb="aastu-library" targettable="book_tag">
                            <div class="action_content">
                    <span class="action collapse">
            Collapse
                    </span>
            ...
            Queried time
                            ...
                            <span class="query">CREATE TABLE `aastu-library`.`book_tag` ( `resource_id` INT(11) NOT NULL ,  `tag_id` INT(11) NOT NULL ) ENGINE = InnoDB;</span>
                        </div>
                                            <div class="message history collapsed hide"
                            targetdb="aastu-library" targettable="donate_record">
                            <div class="action_content">
                    <span class="action collapse">
            Collapse
                    </span>
            ...
            Queried time
                            ...
                            <span class="query">CREATE TABLE `aastu-library`.`donate_record` ( `record_id` INT(11) NOT NULL AUTO_INCREMENT ,  `donate_date` DATETIME NOT NULL ,  `user_id` INT(11) NOT NULL ,  `resource_id` INT(11) NOT NULL ,    PRIMARY KEY  (`record_id`)) ENGINE = InnoDB;</span>
                        </div>
