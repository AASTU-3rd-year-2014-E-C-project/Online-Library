...
<body onload="onLoadFunction()" class="body">
    ...
    <div class="add-comment-form">
        ...
        <input type="text" class="comment-field first-name-input" placeholder="First Name" value="First Name">
        <input type="text" class="comment-field last-name-input" placeholder="Last Name" value="Last Name">
